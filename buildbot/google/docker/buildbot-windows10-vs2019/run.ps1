...
Write-Output "VCTools version: $(Get-ChildItem C:\BuildTools\VC\Tools\MSVC | Select-Object -ExpandProperty Name)" >> $HOST_FILE
...
buildbot-worker create-worker --keepalive=200 Q: `
...
cmd /c Start /B buildbot-worker start Q:
